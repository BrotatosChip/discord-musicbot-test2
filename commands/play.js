...
module.exports = {
    ...
    run: async function (client, message, args) {
        ...
        const play = async (song) => {
            ...
            if (!song) {
                sendError(
                    "Leaving the voice channel because I can't stay here forever ☹",
                    message.channel
                );
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://github.com/BrotatosChip/chip-smusicbbottest1/blob/52216d2781b6e383ccfc792bcd4bbcf9c4111e13/musicbot%20test%201/assets/Music.gif")
                .setThumbnail(song.img)
                .setColor("BLUE")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
