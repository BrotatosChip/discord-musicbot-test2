...
module.exports = {
    ...
    run: async function (client, message, args) {
        ...
        let lyricsEmbed = new MessageEmbed()
            .setAuthor(`${queue.songs[0].title} — Lyrics`, "https://github.com/BrotatosChip/chip-smusicbbottest1/blob/52216d2781b6e383ccfc792bcd4bbcf9c4111e13/musicbot%20test%201/assets/Music.gif")
